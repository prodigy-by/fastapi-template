...
class AuthStub(object):
    ...
    def __init__(self, channel):
        ...
        self.deauthenticate = channel.unary_unary(
                '/Auth/deauthenticate',
                request_serializer=auth__pb2.UserRequest.SerializeToString,
                response_deserializer=auth__pb2.CodeResponse.FromString,
                )
...
def add_AuthServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'deauthenticate': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=auth__pb2.UserRequest.FromString,
                    response_serializer=auth__pb2.CodeResponse.SerializeToString,
            ),
    }
...
class Auth(object):
    ...
    def authenticate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Auth/authenticate',
    ...
    def deauthenticate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Auth/deauthenticate',
            auth__pb2.UserRequest.SerializeToString,
            auth__pb2.CodeResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
